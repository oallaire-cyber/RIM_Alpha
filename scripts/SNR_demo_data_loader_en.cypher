...
CREATE (r)-[:IMPACTS_TPO {
  ...
  description: 'Direct severity: this risk directly threatens the profitability objective',
  created_at: datetime()
}]->(t);
...
CREATE (r)-[:IMPACTS_TPO {
  id: 'IMP-03',
  impact_level: 'Critical',
  description: 'Direct severity: this risk threatens the series production start objective',
  created_at: datetime()
}]->(t);
...
CREATE (r)-[:IMPACTS_TPO {
  id: 'IMP-04',
  impact_level: 'Critical',
  description: 'Direct severity: non-compliance prevents obtaining NRC certification',
  created_at: datetime()
}]->(t);
